...
public class Direction 
{
	...
	Direction(Scanner fileIn2)
	{
		...
		trimmed2=Game.getCleanLine(fileIn2);
	...
	/*public void print1()
	{
		System.out.println ("PLACE FROM:" + this.from.name() + " ---->   PLACE TO:" + this.to.name() + " by direction: (" + this.getdefaultDir() + ")");
		System.out.println ("ID: " + dirNum);
		System.out.println ("DOOR STATUS: " + roomstatus);
		System.out.println ("Lock Pattern: " + lockNum + "\n\n");
	}*/
